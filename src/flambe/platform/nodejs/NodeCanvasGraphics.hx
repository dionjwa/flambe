...
class NodeCanvasGraphics
    implements InternalGraphics
{
    public var canvas (get, null) :NodeCanvasElement;
        ...
        sourceX :Float, sourceY :Float, sourceW :Float, sourceH :Float)
    {
        ...
        var texture :NodeCanvasTexture = cast texture;
    ...
    private var _canvasCtx :NodeCanvasRenderingContext2D;
    private var _canvas :NodeCanvasElement;
